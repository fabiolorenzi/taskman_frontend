...
function CreateTask() {
    ...
    function getTasks() {
        fetch(`https://taskman-backend.hopto.org/api/v1/tasks/${session.data.user}?project=${projectParams}&iteration=${iterationParams}`, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json"
    ...
    const submitButton = e => {
        e.preventDefault();
        fetch(`https://taskman-backend.hopto.org/api/v1/tasks/${session.data.user}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json"
